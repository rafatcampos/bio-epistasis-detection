...
int main(int argc, char **argv)
{
    ...
    uint* dev_solutions  = (uint*) cl::sycl::malloc_shared(SUBSLICES * sizeof(uint), device, context);
    float* dev_scores = (float*) cl::sycl::malloc_shared(num_snp * num_snp * sizeof(float), device, context);
